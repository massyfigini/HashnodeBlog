...
You can find the [html results here](https://massyfigini.github.io/Course_Project_2.html), the [R Markdown format here](https://github.com/massyfigini/ReproducibleResearch_CP2/blob/master/Course_Project_2.Rmd) and the final [RPubs publication here](https://rpubs.com/massyfigini/ReproducibleResearch_CP2).  
